			...
			for( var i=0;i<DTS.length;i++)
				{
					...
					text+='<a href="#" ><button class="click" value="'+i+'" name="'+tam+'"><div class="sanpham-item"><div class="aaa"><img class="image" src="'+xmllink+'"></div><div class="sanpham-item-text"><ul><li><b class="ten">'+xmlten+'</b></li><li class="giakm"> <span class="gia">'+gb+'</span><sup>đ</sup></li><li><a ><span class="giagoc"> '+giagoc+' <sup>đ</sup></span></a><span > -'+xmlgg+'%</span></li></ul></div><button  class="bi bi-cart-plus-fill giohang nut_tvgh nut_gh"> </button></div></button></a>';	
				}
			...
			for(var i=0;i<DTS.length&&i<sl*2;i++)
				{
					...
					var giaban = xmlgia - (xmlgia*xmlgg /100);
					var gb = giaban.toLocaleString('de-DE');
					t+='<a class="aaaa" href="#" onClick="ChuyenTrangChiTiet2('+i+',0)"><div class="sanpham-item item-sale"><div class="aaa"><img class="image" src="'+xmllink+'"></div><div class="sanpham-item-text"><ul><li><b class="ten">'+xmlten+'</b></li><li class="giakm"> <span class="gia">'+gb+'</span><sup>đ</sup></li><li><a ><span class="giagoc"> '+giagoc+' <sup>đ</sup></span></a><span > -'+xmlgg+'%</span></li></ul></div><button  class="bi bi-cart-plus-fill giohang btt" style="margin: 0px; width: 284px; margin-left: -142px; margin-top: -113px; opacity:0;" > </button></div></a>';	
					if(j%sl==0)
						{
...
function ChuyenTrangChiTiet2(path)
			{
				var xml = new XMLHttpRequest();
			xml.open('GET',path.name,false);
			var vt= path.value;
